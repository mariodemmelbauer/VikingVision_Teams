...
const sideNav: CSSProperties = { position:'sticky', top:0, height:'100vh', boxSizing:'border-box', padding:'18px 14px', background:'#101512', color:'#fff', display:'flex', flexDirection:'column', justifyContent:'space-between', borderRight:'1px solid rgba(255,255,255,.06)' };
...
const brandMark: CSSProperties = { flex:'0 0 auto', width:'34px', height:'34px', borderRadius:'10px', display:'flex', alignItems:'center', justifyContent:'center', background:'#0b7a3b', color:'#fff', fontWeight:900, fontSize:'11px', letterSpacing:'.04em' };
